          ...
          <section class="wrapper">            
            ...
            <div class="row">
             <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-user"></i>Roles</li>                          
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs">
                      ...
                      <li role="presentation" class="active"><a href="roles">Roles</a></li>
                    </ul>
                <div class="x_panel">
                 <div>
                      ...
                      <div class="navbar-right panel_toolbox">
                           ...
                           <li style="list-style: none;">
                            <a for="DeleteAll" href="#clear-contacts" data-toggle="modal" data-target="#clear-contacts">
                                <button class="btn btn-danger btn-outline" style="vertical-align: middle;"><i class="fa fa-info"></i> Clear Roles</button>
                            </a>
                            <!-- delete modal user -->
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert alert-danger">
                                                This will erase all roles from database. Are you sure you want to clear all roles?
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="clearRoles" style="margin-bottom:5px;" class="btn btn-primary"><i class="fa fa-check"></i> Yes</a>
                                        </div>
                                    </div>
                            ...
                            <button class="btn btn-success btn-outline" onclick="add_role()" style="vertical-align: middle;"><i class="fa fa-plus"></i> Add Role</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" placeholder="Role Details" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
