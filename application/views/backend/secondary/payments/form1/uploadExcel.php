...
<form action="payments_controller_1/add" role="form" method="post" enctype="multipart/form-data">
    <div>
...
<?php  $this->load->view('backend/secondary/payments/form1/layouts/footer'); ?>
