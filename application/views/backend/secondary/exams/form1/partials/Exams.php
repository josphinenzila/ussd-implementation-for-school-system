          ...
          <section class="wrapper">            
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="nav nav-tabs">
                      <li role="presentation" class="active"><a href="exams1">Form1</a></li>
                                ...
                                <div class="modal fade" id="clear-contacts" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="clearExams1" style="margin-bottom:5px;" class="btn btn-primary"><i class="fa fa-check"></i> Yes</a>
                                        </div>
                                    </div>
