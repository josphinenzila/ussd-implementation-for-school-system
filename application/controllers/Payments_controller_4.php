...
class Payments_controller_4 extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('payments_model_4','payment');
	...
	public function index()
	{
	  ...
	  $this->load->view('backend/secondary/payments/form4/Payments',$data);
	}
    ...
    public function upload() {
      ...
      $data['logo']=$this->session->userdata('logo');
  	  ...
  	  $this->load->view('backend/secondary/payments/form4/uploadExcel',$data);
                ...
                if($this->upload->do_upload('payments')){
                 ...
                 unlink("assets/uploads/secondary/".$file);
                    ...
                    $file = '';
        			 ...
        			 redirect(base_url().'uploadPayments4');
            }
         }
      ...
      $objPHPExcel = PHPExcel_IOFactory::load($storagename);
		...
		$arrayCount = count($allDataInSheet);  // Here get total count of row in that Excel sheet
 		...
 		for($i=2;$i<=$arrayCount;$i++){
        	...
        	$this->load->database();
        	$this->load->model('payments_model_4');
   			$this->payments_model_4->add_data($data_user);
  			}
