          ...
          <section class="wrapper">            
            ...
            <div class="row">
             <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-list-alt"></i>Exams</li>                          
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="nav nav-tabs">
                      <li role="presentation"><a href="exams1">Form1</a></li>
                      <li role="presentation" class="active"><a href="exams2">Form 2</a></li>
                      <li role="presentation"><a href="exams3">Form 3</a></li>
                      <li role="presentation"><a href="exams4">Form 4</a></li>
                    </ul>
                      ...
                      <div class="navbar-right panel_toolbox">
                           ...
                           <li style="list-style: none;">
                            <a for="DeleteAll" href="#clear-contacts" data-toggle="modal" data-target="#clear-contacts">
                                <button class="btn btn-danger btn-outline" style="vertical-align: middle;"><i class="fa fa-info"></i> Clear Exams</button>
                            </a>
                            <!-- delete modal user -->
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert alert-danger">
                                                This will erase all exam results from database. Are you sure you want to clear all exam results?
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="clearExams2" style="margin-bottom:5px;" class="btn btn-primary"><i class="fa fa-check"></i> Yes</a>
                                        </div>
                                    </div>
                            ...
                            <button class="btn btn-success btn-outline" onclick="add_exam()" style="vertical-align: middle;"><i class="fa fa-plus"></i> Add Student</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="exam_name" placeholder="Exam Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="results" placeholder="Results" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
