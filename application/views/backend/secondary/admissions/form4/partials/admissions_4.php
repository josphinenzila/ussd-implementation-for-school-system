          ...
          <section class="wrapper">            
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                   <ul class="nav nav-tabs">
                      ...
                      <li role="presentation" class="active"><a href="admission4">Form 4</a></li>
                      ...
                      <div class="navbar-right panel_toolbox">
                           ...
                           <li style="list-style: none;">
                            <a for="DeleteAll" href="#clear-admissions" data-toggle="modal" data-target="#clear-admissions">
                                <button class="btn btn-danger btn-outline" style="vertical-align: middle;"><i class="fa fa-info"></i> Clear Admissions</button>
                            </a>
                            <!-- delete modal user -->
                                <div class="modal fade" id="clear-admissions" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="clearAdmissions4" style="margin-bottom:5px;" class="btn btn-primary"><i class="fa fa-check"></i> Yes</a>
                                        </div>
                                    </div>
