          ...
          <section class="wrapper">            
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                   ...
                   <ul class="nav nav-tabs">
                      <li role="presentation" class="active"><a href="admission1">Form1</a></li>
                 ...
                 <div>
                     <div class="navbar-right panel_toolbox">
                           ...
                           <li style="list-style: none;">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert alert-danger">
                                                This will erase all admissions details from database. Are you sure you want to clear all student admission?
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="clearAdmissions1" style="margin-bottom:5px;" class="btn btn-primary"><i class="fa fa-check"></i> Yes</a>
                                        </div>
                                    </div>
                            ...
                            <button class="btn btn-success btn-outline" onclick="add_person()" style="vertical-align: middle;"><i class="fa fa-plus"></i> Add Entries</button>
                          
                          
                         
                           <!--  <a href="uploadAdmission1">
