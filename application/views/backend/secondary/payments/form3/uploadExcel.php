...
<form action="payments_controller_3/add" role="form" method="post" enctype="multipart/form-data">
    <div>
...
<?php  $this->load->view('backend/secondary/payments/form3/layouts/footer'); ?>
