...
<form action="payments_controller_2/add" role="form" method="post" enctype="multipart/form-data">
    <div>
...
<?php  $this->load->view('backend/secondary/payments/form2/layouts/footer'); ?>
